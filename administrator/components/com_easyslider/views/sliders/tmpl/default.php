...
?>
	<div id="jsn-page-list" class="jsn-master jsn-page-list jsn-easyslider-hide">
		...
		<script type="text/javascript"
		        src="<?php echo JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/underscore/underscore.js' ?>"></script>
		<script>
						...
						'items': {
							...
							map: {
								...
								"video.type": function ( value, data, oldData ) {
									switch ( value ) {
										case 'youtube':
											data.style_desktop.video.youtube = oldData.video.url;
											break;
										case 'vimeo':
											data.style_desktop.video.vimeo = oldData.video.url;
											break;
										case 'local':
											data.style_desktop.video.mp4 = oldData.video.url;
											break;
									}
								},
