	...
	<div class="panel-body">
		...
		<div class="tab-content">
				...
				<div class="row flex">
					<div class="btn-group btn-group-xs">
						...
						<a class="btn btn-default fonts-select-btn">
							<span class="font-name" data-bind="style.font.family"></span>
					...
					<div class="input-group input-group-xs">
						...
						<input type="text" class="form-control input-70" data-bind="style.font.color">
						<input type="color" class="form-control input-50" data-bind="style.font.color">
					</div>
				</div>
				<div class="row flex">
					<div class="input-group input-group-xs">
			...
			<div role="tabpanel" class="tab-pane form-inline" id="item-inspector-video">
				...
				<div class="row flex">
					<div class="input-group input-group-xs">
						<label><?php echo JText::_('JSN_EASYSLIDER_YOUTUBE_URL');?></label>
						<input type="text" class="form-control input-150" data-bind="style.background.video.youtube">
					</div>
					<div class="input-group input-group-xs">
						<label><?php echo JText::_('JSN_EASYSLIDER_VIMEO_URL');?></label>
						<input type="text" class="form-control input-150" data-bind="style.background.video.vimeo">
					</div>
				...
				<div class="row flex">
					<div class="input-group input-group-xs">
						...
						<input type="text" class="form-control input-100" data-bind="style.background.video.mp4">
					</div>
					<div class="input-group input-group-xs">
						<label><?php echo JText::_('JSN_EASYSLIDER_OGG');?></label>
						<input type="text" class="form-control input-100" data-bind="style.background.video.ogg">
					</div>
					<div class="input-group input-group-xs">
						<label><?php echo JText::_('JSN_EASYSLIDER_WEBM');?></label>
						<input type="text" class="form-control input-100" data-bind="style.background.video.webm">
					</div>
					<div class="flexible"></div>
					<div class="input-group input-group-xs text-center input-50">
					...
					<div class="col-xs-8">
						<div class="row">
							<div class="col-xs-12 flex">
								<div class="input-group input-group-xs">
									<label><?php echo JText::_('JSN_EASYSLIDER_FILL');?></label>
									<input type="text" class="form-control input-50" data-bind="style.background.color">
									<input type="color" class="form-control" data-bind="style.background.color">
								</div>
								<div class="input-group input-group-xs">
									<label><?php echo JText::_('JSN_EASYSLIDER_BORDER');?></label>
									<select class="form-control input-70" data-bind="style.border.style">
								...
								<div class="input-group input-group-xs">
									<label><?php echo JText::_('JSN_EASYSLIDER_WIDTH');?></label>
									<input type="number" class="form-control input-50" data-bind="style.border.width" min="0">
								</div>
								<div class="input-group input-group-xs">
									<label><?php echo JText::_('JSN_EASYSLIDER_COLOR');?></label>
									<input type="color" class="form-control input-50" data-bind="style.border.color">
								</div>
								<div class="input-group input-group-xs">
									<label><?php echo JText::_('JSN_EASYSLIDER_RADIUS');?></label>
									<input type="number" class="form-control input-50" data-bind="style.border.radius" min="0">
								</div>
							</div>
						</div>
					</div>
