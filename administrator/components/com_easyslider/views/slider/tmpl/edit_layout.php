			...
			<div class="es-header flex flex-layout es-panel space-between">
				<div class="header-left flex">
					<div class="es-branding flex">
						...
						<svg width="60" height="60" viewBox="-5 5 80 80" style="margin: -10px 0; ">
							<style>
								#logo {
									/*transformb*/
								...
								.container {
									...
									-moz-transform: translate(10px,40px) scale(0.8);
								}
								.g1 {}
								.g2 {
							...
							<g class="container">
								<g class="g1"><path class="l1" d="M10 10 L60 10 L60 20 L25 20 L25 30 L60 30 L60 40 L25 40 L25 50 L60 50 L60 60 L10 60 Z"></path></g>
								<g class="g2"><path class="l2" d="M10 10 L20 10 L20 50 L60 50 L60 60 L10 60 Z"></path></g>
								<g class="g3"><path class="l3" d="M10 10 L20 10 L20 50 L60 50 L60 60 L10 60 Z"></path></g>
							</g>
						</svg>
...
<!--						<a class="btn btn-default slider-settings-btn">--><?php //echo JText::_('JSN_EASYSLIDER_SETTINGS');?><!--</span></a>-->
					</div>
					<div class="btn-group">
