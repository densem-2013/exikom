...
//
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/underscore/underscore.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/backbone/backbone.js');
//
////JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/backbone/backbone.undo.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/jquery-ui/jquery-ui.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/jquery-ui/jquery-ui.resizable.snap.ext.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/mousetrap.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/tinycolor/tinycolor.js');
//
...
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/model.js');
//
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/utils.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/jquery.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/view.js');
//
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/easing.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/tween.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/lib/split.js');
//
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/conflict.js');
//
//
//// APP JS
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/model/core.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/model/item.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/model/slide.js');
//JSNHtmlAsset::addScript(JSNES_PLG_SYSTEM_ASSETS_URL . 'js/model/slider.js');
//
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/panel.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/picker.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/toolbar.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/canvas.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/grids.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/items.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/layers.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/frames.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/thumbs.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/overlays.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/timeline.js');
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'slider/js/view/app.js');
//
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . '/js/slider.js');
//
//JSNHtmlAsset::addScript(JSNES_ASSETS_URL . 'js/3rd-party/noty/jquery.noty.js');
...
<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/bootstrap/js/bootstrap.js'); ?>"></script>

<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/underscore/underscore.js'); ?>"></script>
<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/backbone/backbone.js'); ?>"></script>

<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/jquery-ui/jquery-ui.js'); ?>"></script>
...
<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/tinycolor/tinycolor.js'); ?>"></script>

<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/rangy/bundle.js'); ?>"></script>
<script src="<?php echo (JSNES_PLG_SYSTEM_ASSETS_URL . 'lib/mediumjs/medium.js'); ?>"></script>
        ...
        ES_Config: {
            value: Object.freeze({
                URL: Object.freeze({
                    ...
                    CREATE_SLIDER: 'index.php?option=com_easyslider&task=slider.createNewSlider',
                    UPDATE_SLIDER: 'index.php?option=com_easyslider&task=slider.updateSliderData',
