		...
		<div class="row">
			...
			<div class="col-xs-8">
				<div class="input-group input-group-xs">
					<input type="text" class="form-control input-xs" data-bind="color" placeholder="#000000">
					<span class="input-group-addon">
						<input type="color" class="form-control input-xs" data-bind="color">
					</span>
				</div>
			</div>
		</div> <!-- row end -->
		...
		<div class="tab-content">
			...
			<div id="setting-style-tab" role="tabpanel" class="tab-pane form-horizontal">
				...
				<div class="row">
					...
					<div class="col-xs-6">
						<div class="input-group input-group-xs">
							<input type="text" class="form-control input-xs" data-bind="background.color" placeholder="#000000">
							<span class="input-group-addon">
								<input type="color" class="form-control input-xs" data-bind="background.color">
							</span>
						</div>
					</div>
				</div> <!-- row end -->
