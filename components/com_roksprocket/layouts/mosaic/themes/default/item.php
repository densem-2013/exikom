...
<li<?php echo strlen($item->custom_tags) ? ' class="'.$item->custom_tags.'"' : ''; ?> data-mosaic-item>
	<div class="sprocket-mosaic-item" data-mosaic-content>
		...
		<div class="sprocket-padding">
			...
			<div class="sprocket-mosaic-image-container">
				...
				<?php if ($item->getPrimaryLink()) : ?>
						...
						<span class="sprocket-mosaic-hovercontent"><span> </span><span>+</span><?php rc_e('READ_MORE'); ?></span>
				</a>
				<?php endif; ?>
			</div>
			<?php endif; ?>
		...
		<!--	<?php //if ($item->getPrimaryLink()) : ?>
			<a href="<?php //echo $item->getPrimaryLink()->getUrl(); ?>" class="sprocket-readmore"><span><?php //echo $item->getTitle()/*rc_e('READ_MORE')*/; ?></span></a>
			<?php //endif; ?>
		-->
